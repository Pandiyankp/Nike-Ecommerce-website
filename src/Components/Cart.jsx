...
import { selectCartState ,selectTotalAmount,setCloseCart, setGetTotals} from '../app/CartSlice';
import CartCount from './cart/CartCount';
import CartEmpty from './cart/CartEmpty';
import CartItem from './cart/CartItem';
import { selectCartItems, setClearCartItems, selectTotalQantity } from './../app/CartSlice';
...
'opacity-0 invisible translate-x-8'}`}>
    ...
    `}>
        ...
        <CartCount totalQantity={totalQantity} onCartToggle={onCartToggle} onClearCartItem={onClearCartItem}/>
        {cartItems.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : 
        
        
        <div className="">
          <div className="flex items-start justify-start flex-col gap-y-7 lg:gap-y-5 overflow-y-scroll h-[80vh] scroll-smooth 
          scroll-hidden py-3">
          ...
          <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
            ...
            <div className="grid items-center gap-2 ">
              ...
              <button className="button-theme bg-theme-cart text-white" type='button'>Checkout</button>
            </div>
          </div>
        </div>
}
